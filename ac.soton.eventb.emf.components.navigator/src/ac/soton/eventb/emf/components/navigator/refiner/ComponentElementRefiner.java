...
public class ComponentElementRefiner extends StatemachineElementRefiner {
	...
	protected void populateReferenceMap(final Map<EReference,RefHandling> referencemap){
		...
		referencemap.put(ComponentsPackage.Literals.ABSTRACT_IN_SENDER__DESTINATIONS, RefHandling.EQUIV);
		referencemap.put(ComponentsPackage.Literals.ABSTRACT_IN_RECEIVER__SOURCE, RefHandling.EQUIV);
		referencemap.put(ComponentsPackage.Literals.ABSTRACT_OUT_RECEIVER__SOURCE, RefHandling.EQUIV);
		referencemap.put(ComponentsPackage.Literals.ABSTRACT_OUT_SENDER__DESTINATION, RefHandling.EQUIV);
