...
import ac.soton.eventb.emf.components.diagram.providers.ComponentsValidationProvider;
...
public class ValidateAction extends Action {
	...
	/**
	 * (altered to get the label attribute if there is no name attribute)
	 * @generated not
	 */
		...
		if (target.isSetElement() && target.getElement() != null) {
			return new Diagnostician() {
				public String getObjectLabel(EObject eObject) {
					return NameUtils.getQualifiedName(eObject);
				}
	...
	//				ComponentsMarkerNavigationProvider.MARKER_TYPE, true,
