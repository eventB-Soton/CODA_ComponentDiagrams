 ...
 * @since 6.0
 */
public class ParentWakeQueueNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ComponentsVisualIDRegistry
						.getType(ac.soton.eventb.emf.components.diagram.edit.parts.ParentWakeQueueNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ParentWakeQueueNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ParentWakeQueueLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ParentWakeQueueLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ParentWakeQueueLabelFigure() {
			this.setText("<name?>");
