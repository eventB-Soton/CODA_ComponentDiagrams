...
import ac.soton.eventb.emf.components.diagram.edit.policies.ExternalItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ExternalEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ExternalEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ExternalItemSemanticEditPolicy());
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.eventb.emf.components.diagram.edit.parts.ExternalEditPart.VISUAL_ID));
		}
		return parser;
	}
	 ...
	 * @generated
	 */
	public class ExternalFigure extends WrappingLabel {
