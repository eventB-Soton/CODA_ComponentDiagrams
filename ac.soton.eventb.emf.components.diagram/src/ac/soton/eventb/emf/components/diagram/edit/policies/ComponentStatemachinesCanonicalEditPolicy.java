 ...
 * @generated
 */
public class ComponentStatemachinesCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getComponentStatemachines_7004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == StatemachineEditPart.VISUAL_ID
				|| visualID == SynchronousStatemachineEditPart.VISUAL_ID
				|| visualID == ProcessStatemachineEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getComponentStatemachines_7004SemanticChildren((View) getHost()
						.getModel());
