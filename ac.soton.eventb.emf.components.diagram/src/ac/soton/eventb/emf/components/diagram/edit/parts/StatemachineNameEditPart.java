 ...
 * @generated
 */
public class StatemachineNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ComponentsVisualIDRegistry
						.getType(ac.soton.eventb.emf.components.diagram.edit.parts.StatemachineNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	protected void setFontColor(Color color) {
		getFigure().setForegroundColor(this.getFigure().getForegroundColor());
	}
