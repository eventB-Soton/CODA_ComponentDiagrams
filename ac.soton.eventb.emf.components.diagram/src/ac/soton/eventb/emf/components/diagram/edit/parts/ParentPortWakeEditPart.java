...
import ac.soton.eventb.emf.components.diagram.edit.policies.ParentPortWakeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ParentPortWakeEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public ParentPortWakeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ParentPortWakeItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ParentPortWakeOperationFigure();
	}

	/**
	 * @generated
	 */
	public ParentPortWakeOperationFigure getPrimaryShape() {
		return (ParentPortWakeOperationFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof ParentPortWakeLabelEditPart) {
	 ...
	 * @generated
	 */
	public class ParentPortWakeOperationFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		public ParentPortWakeOperationFigure() {
		...
		private void createContents() {
			...
			ParentPortWakeOperationIcon parentPortWakeOperationIconImage0 = new ParentPortWakeOperationIcon();

			this.add(parentPortWakeOperationIconImage0);
