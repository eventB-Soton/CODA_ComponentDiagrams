...
import ac.soton.eventb.emf.components.diagram.edit.policies.TransitionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TransitionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.eventb.emf.components.diagram.edit.parts.TransitionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new TransitionOpFigure();
	}

	/**
	 * @generated
	 */
	public class TransitionOpFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TransitionOpFigure() {
