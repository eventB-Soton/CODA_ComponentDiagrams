 ...
 * @generated
 */
public class ParentSynchronousStatemachineNameEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				ComponentsVisualIDRegistry
						.getType(ac.soton.eventb.emf.components.diagram.edit.parts.ParentSynchronousStatemachineNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ParentSynchronousStatemachineNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ParentSynchronousStatemachineLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ParentSynchronousStatemachineLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ParentSynchronousStatemachineLabelFigure() {
			this.setText("<name?>");
		}
