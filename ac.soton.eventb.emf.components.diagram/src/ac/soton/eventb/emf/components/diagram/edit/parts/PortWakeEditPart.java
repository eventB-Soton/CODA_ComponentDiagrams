...
import ac.soton.eventb.emf.components.diagram.edit.policies.PortWakeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PortWakeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PortWakeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PortWakeItemSemanticEditPolicy());
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.eventb.emf.components.diagram.edit.parts.PortWakeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new PortWakeFigure();
	}

	/**
	 * @generated
	 */
	public class PortWakeFigure extends WrappingLabel {
