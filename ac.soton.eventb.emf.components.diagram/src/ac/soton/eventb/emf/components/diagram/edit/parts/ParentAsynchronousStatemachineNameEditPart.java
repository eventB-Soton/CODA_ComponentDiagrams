 ...
 * @since 6.0
 */
public class ParentAsynchronousStatemachineNameEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				ComponentsVisualIDRegistry
						.getType(ac.soton.eventb.emf.components.diagram.edit.parts.ParentAsynchronousStatemachineNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ParentAsynchronousStatemachineNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ParentAsynchronousStatemachineLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ParentAsynchronousStatemachineLabelFigure extends
			WrappingLabel {
