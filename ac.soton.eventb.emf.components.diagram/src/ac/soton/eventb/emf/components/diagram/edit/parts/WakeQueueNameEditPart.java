 ...
 * @generated
 */
public class WakeQueueNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ComponentsVisualIDRegistry
						.getType(ac.soton.eventb.emf.components.diagram.edit.parts.WakeQueueNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public WakeQueueNameEditPart(View view) {
		super(view);
	}
