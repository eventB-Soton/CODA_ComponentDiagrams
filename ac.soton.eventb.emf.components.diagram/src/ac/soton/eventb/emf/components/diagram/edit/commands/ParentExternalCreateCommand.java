 ...
 * @generated
 */
public class ParentExternalCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ParentExternalCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		External newElement = ComponentsFactory.eINSTANCE.createExternal();
	 ...
	 * @generated
	 */
	protected void doConfigure(External newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
