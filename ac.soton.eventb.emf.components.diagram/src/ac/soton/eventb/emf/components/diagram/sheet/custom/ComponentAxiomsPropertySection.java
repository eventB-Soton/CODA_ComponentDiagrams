...
/**
 * Component axioms tab table property section.
 *
 * @author Colin Snook
 */


public class ComponentAxiomsPropertySection extends AbstractEditTableWithDefaultNamingPropertySection {

	@Override
	protected EReference getFeature() {
		return ComponentsPackage.eINSTANCE.getComponent_Axioms();
	}
