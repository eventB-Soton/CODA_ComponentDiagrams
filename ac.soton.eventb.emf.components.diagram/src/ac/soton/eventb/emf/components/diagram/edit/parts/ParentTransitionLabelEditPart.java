...
public class ParentTransitionLabelEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ComponentsVisualIDRegistry
						.getType(ac.soton.eventb.emf.components.diagram.edit.parts.ParentTransitionLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ParentTransitionLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ParentTransitionOperationLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ParentTransitionOperationLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ParentTransitionOperationLabelFigure() {
