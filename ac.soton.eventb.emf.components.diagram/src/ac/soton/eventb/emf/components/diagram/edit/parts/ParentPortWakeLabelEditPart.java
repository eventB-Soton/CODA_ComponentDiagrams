...
public class ParentPortWakeLabelEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ComponentsVisualIDRegistry
						.getType(ac.soton.eventb.emf.components.diagram.edit.parts.ParentPortWakeLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ParentPortWakeLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ParentPortWakeOperationLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ParentPortWakeOperationLabelFigure extends WrappingLabel {
