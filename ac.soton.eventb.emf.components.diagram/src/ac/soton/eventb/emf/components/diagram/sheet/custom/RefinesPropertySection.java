...
/**
 * Refines property section.
 * This property section will work for any EventBNamed EventBObject element that has a feature called refines.
 * (Nb. the refines feature should be a function to the same meta class)
 * 
 * @author cfs
 *
 */
public class RefinesPropertySection extends AbstractEnumerationPropertySection {
	...
	protected EStructuralFeature getFeature() {
		return eObject.eClass().getEStructuralFeature("refines");
	}

	@Override
	protected String[] getEnumerationFeatureValues() {
		EList<EObject> elementsToRefine = getElementsToRefine();
	...
	protected List<? extends Object> getAvailableDataElements() {
		return getElementsToRefine();
	}

	@SuppressWarnings("unchecked")
	private EList<EObject> getElementsToRefine(){
