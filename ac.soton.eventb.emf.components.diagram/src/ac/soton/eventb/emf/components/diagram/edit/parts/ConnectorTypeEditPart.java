 ...
 * @generated
 */
public class ConnectorTypeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ConnectorTypeEditPart(View view) {
		super(view);
	}
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.eventb.emf.components.diagram.edit.parts.ConnectorTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	 ...
	 * @generated NOT
	 */
	private static final String RodinMathFontName = JFaceResources.getFont(
			PreferenceConstants.RODIN_MATH_FONT).getFontData()[0].getName();

	protected void refreshFont() {
		FontStyle style = (FontStyle) getFontStyleOwnerView().getStyle(
				NotationPackage.eINSTANCE.getFontStyle());
		if (style != null) {
			FontData fontData = new FontData(RodinMathFontName, //style.getFontName(),					<<<<<<<<<<<<<<<<<<<<<CUSTOMISED
