 ...
 * @since 6.0
 */
public class ParentTransitionEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public ParentTransitionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ParentTransitionItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ParentTransitionOperationFigure();
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof ParentTransitionLabelEditPart) {
	 ...
	 * @generated
	 */
	public class ParentTransitionOperationFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		public ParentTransitionOperationFigure() {
		...
		private void createContents() {
			...
			ParentTransitionOperationIcon parentTransitionOperationIconImage0 = new ParentTransitionOperationIcon();

			this.add(parentTransitionOperationIconImage0);
