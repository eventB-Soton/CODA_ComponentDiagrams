 ...
 * @generated
 */
public class ComponentWakeQueuesCanonicalEditPolicy extends CanonicalEditPolicy {

	/**
	 * @generated
	 */
	protected EStructuralFeature getFeatureToSynchronize() {
		return ComponentsPackage.eINSTANCE.getComponent_WakeQueues();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getComponentWakeQueues_7007SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return WakeQueueEditPart.VISUAL_ID == ComponentsVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getComponentWakeQueues_7007SemanticChildren((View) getHost()
						.getModel());
