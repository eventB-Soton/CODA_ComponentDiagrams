 ...
 * @generated
 */
public class OpenComponentDiagramEditPolicy extends OpenEditPolicy {
	...
	private static class OpenDiagramCommand extends
							...
							for (Iterator it = diagramFacet.eResource()
								...
								if (nextResource.isLoaded()
										&& !getEditingDomain().isReadOnly(
												nextResource)) {
									nextResource
											.save(ComponentsDiagramEditorUtil
													.getSaveOptions());
								}
							}
		...
		protected String getEditorID() {
			return "ac.soton.eventb.emf.components.diagram.part.ComponentsDiagramEditorID";
		}
	}
