 ...
 * @generated
 */
public class ParentMethodLabelEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ComponentsVisualIDRegistry
						.getType(ac.soton.eventb.emf.components.diagram.edit.parts.ParentMethodLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ParentMethodLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ParentMethodOperationLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ParentMethodOperationLabelFigure extends WrappingLabel {
