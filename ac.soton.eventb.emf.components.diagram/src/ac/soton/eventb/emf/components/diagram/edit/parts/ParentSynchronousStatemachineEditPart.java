...
public class ParentSynchronousStatemachineEditPart extends
	 ...
	 * @generated
	 */
	public ParentSynchronousStatemachineEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ParentSynchronousStatemachineItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof ParentSynchronousStatemachineNameEditPart) {
