 ...
 * @generated
 */
public class SubcomponentCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public SubcomponentCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		AbstractComponentModel owner = (AbstractComponentModel) getElementToEdit();
