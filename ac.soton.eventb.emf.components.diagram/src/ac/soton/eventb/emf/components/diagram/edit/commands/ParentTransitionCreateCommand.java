 ...
 * @generated
 */
public class ParentTransitionCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public ParentTransitionCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Transition newElement = ComponentsFactory.eINSTANCE.createTransition();
