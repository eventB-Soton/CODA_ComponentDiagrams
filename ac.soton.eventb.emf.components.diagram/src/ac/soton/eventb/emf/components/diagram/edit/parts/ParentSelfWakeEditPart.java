...
import ac.soton.eventb.emf.components.diagram.edit.policies.ParentSelfWakeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ParentSelfWakeEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public ParentSelfWakeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ParentSelfWakeItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ParentSelfWakeOperationFigure();
	}

	/**
	 * @generated
	 */
	public ParentSelfWakeOperationFigure getPrimaryShape() {
		return (ParentSelfWakeOperationFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof ParentSelfWakeLabelEditPart) {
	 ...
	 * @generated
	 */
	public class ParentSelfWakeOperationFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		public ParentSelfWakeOperationFigure() {
		...
		private void createContents() {
			...
			ParentSelfWakeOperationIcon parentSelfWakeOperationIconImage0 = new ParentSelfWakeOperationIcon();

			this.add(parentSelfWakeOperationIconImage0);
