 ...
 * @generated
 */
public class ComponentSubcomponentsCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getComponentSubcomponents_7006SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return SubcomponentEditPart.VISUAL_ID == ComponentsVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getComponentSubcomponents_7006SemanticChildren((View) getHost()
						.getModel());
