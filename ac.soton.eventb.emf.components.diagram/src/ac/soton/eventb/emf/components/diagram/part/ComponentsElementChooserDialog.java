...
public class ComponentsElementChooserDialog extends DefaultElementChooserDialog {
	...
	public ComponentsElementChooserDialog(Shell parentShell, View view,
		...
		super(parentShell, view, new ComponentsElementChooserDialogContextImpl(
				allowMultiSelection));
	}
	 ...
	 * @generated
	 */
	private static class ComponentsElementChooserDialogContextImpl implements
		 ...
		 * @generated
		 */
		private ComponentsElementChooserDialogContextImpl(
				boolean allowMultiSelection) {
