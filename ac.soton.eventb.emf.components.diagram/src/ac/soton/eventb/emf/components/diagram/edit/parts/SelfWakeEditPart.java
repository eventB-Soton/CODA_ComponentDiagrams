...
import ac.soton.eventb.emf.components.diagram.edit.policies.SelfWakeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SelfWakeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SelfWakeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SelfWakeItemSemanticEditPolicy());
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.eventb.emf.components.diagram.edit.parts.SelfWakeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new SelfWakeFigure();
	}

	/**
	 * @generated
	 */
	public class SelfWakeFigure extends WrappingLabel {
