 ...
 * @generated
 */
public class ParentProcessStatemachineNameEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				ComponentsVisualIDRegistry
						.getType(ac.soton.eventb.emf.components.diagram.edit.parts.ParentProcessStatemachineNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ParentProcessStatemachineNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ParentProcessStatemachineLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ParentProcessStatemachineLabelFigure extends WrappingLabel {
