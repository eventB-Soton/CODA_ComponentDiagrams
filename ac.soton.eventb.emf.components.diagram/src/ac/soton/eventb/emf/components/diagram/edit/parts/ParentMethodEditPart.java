...
import ac.soton.eventb.emf.components.diagram.edit.policies.ParentMethodItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ParentMethodEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public ParentMethodEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ParentMethodItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ParentMethodOperationFigure();
	}

	/**
	 * @generated
	 */
	public ParentMethodOperationFigure getPrimaryShape() {
		return (ParentMethodOperationFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof ParentMethodLabelEditPart) {
	 ...
	 * @generated
	 */
	public class ParentMethodOperationFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		public ParentMethodOperationFigure() {
		...
		private void createContents() {
			...
			ParentMethodOperationIcon parentMethodOperationIconImage0 = new ParentMethodOperationIcon();

			this.add(parentMethodOperationIconImage0);
