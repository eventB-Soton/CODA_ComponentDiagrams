...
import ac.soton.eventb.emf.components.diagram.edit.policies.SynchronousStatemachineItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SynchronousStatemachineEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SynchronousStatemachineEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SynchronousStatemachineItemSemanticEditPolicy());
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.eventb.emf.components.diagram.edit.parts.SynchronousStatemachineEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new SyncStatemachineFigure();
	}

	/**
	 * @generated
	 */
	public class SyncStatemachineFigure extends WrappingLabel {
