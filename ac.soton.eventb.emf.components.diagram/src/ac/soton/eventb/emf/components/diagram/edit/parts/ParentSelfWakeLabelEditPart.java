 ...
 * @generated
 */
public class ParentSelfWakeLabelEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ComponentsVisualIDRegistry
						.getType(ac.soton.eventb.emf.components.diagram.edit.parts.ParentSelfWakeLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ParentSelfWakeLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ParentSelfWakeOperationLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ParentSelfWakeOperationLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ParentSelfWakeOperationLabelFigure() {
