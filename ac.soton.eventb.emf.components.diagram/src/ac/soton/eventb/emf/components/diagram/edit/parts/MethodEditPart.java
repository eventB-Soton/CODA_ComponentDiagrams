...
import ac.soton.eventb.emf.components.diagram.edit.policies.MethodItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MethodEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.eventb.emf.components.diagram.edit.parts.MethodEditPart.VISUAL_ID));
		}
		return parser;
	}
