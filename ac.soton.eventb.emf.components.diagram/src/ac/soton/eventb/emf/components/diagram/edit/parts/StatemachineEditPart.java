...
import ac.soton.eventb.emf.components.diagram.edit.policies.StatemachineItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StatemachineEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.eventb.emf.components.diagram.edit.parts.StatemachineEditPart.VISUAL_ID));
		}
		return parser;
	}
