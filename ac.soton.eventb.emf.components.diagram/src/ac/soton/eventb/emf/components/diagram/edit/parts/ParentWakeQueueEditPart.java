...
import ac.soton.eventb.emf.components.diagram.edit.policies.ParentWakeQueueItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ParentWakeQueueEditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public ParentWakeQueueEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ParentWakeQueueItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ParentWakeQueueFigure();
	}

	/**
	 * @generated
	 */
	public ParentWakeQueueFigure getPrimaryShape() {
		return (ParentWakeQueueFigure) primaryShape;
	}
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof ParentWakeQueueNameEditPart) {
	 ...
	 * @generated
	 */
	public class ParentWakeQueueFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		public ParentWakeQueueFigure() {
		...
		private void createContents() {
			...
			ParentWakeQueueIcon parentWakeQueueIconImage0 = new ParentWakeQueueIcon();

			this.add(parentWakeQueueIconImage0);
