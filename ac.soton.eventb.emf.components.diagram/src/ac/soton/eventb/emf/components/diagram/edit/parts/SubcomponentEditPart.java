...
import ac.soton.eventb.emf.components.diagram.edit.policies.SubcomponentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SubcomponentEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SubcomponentEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubcomponentItemSemanticEditPolicy());
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.eventb.emf.components.diagram.edit.parts.SubcomponentEditPart.VISUAL_ID));
		}
		return parser;
	}
