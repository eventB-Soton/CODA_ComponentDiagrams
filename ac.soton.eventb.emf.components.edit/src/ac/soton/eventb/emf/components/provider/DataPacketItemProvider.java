...
public class DataPacketItemProvider
	 ...
	 * @generated
	 */
	public DataPacketItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DataPacket"));
	}
	...
	public String getText(Object object) {
		String label = ((DataPacket)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DataPacket_type") :
			getString("_UI_DataPacket_type") + " " + label;
	}
